...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_wave_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/wave.js */ "./src/js/components/wave.js");
...
/* harmony import */ var _components_fancy_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/fancy.js */ "./src/js/components/fancy.js");
...
if (fancyContainers.length > 0) {
  fancyContainers.forEach(container => {
    ...
    _fancyapps_ui__WEBPACK_IMPORTED_MODULE_0__.Fancybox.bind(`[data-fancybox=${dataset}]`, {});
  });
}
  ...
  bindEvents() {
    this.faqItems.forEach(item => {
      ...
      if (header && content && btn) {
        header.addEventListener("click", () => this.toggleItem(item, content, btn));
      }
    });
  }
  equalizeHeights() {
    ...
    for (let i = 0; i < pairsCount; i++) {
      ...
      if (firstColItem && secondColItem) {
        ...
        if (!firstColItem.classList.contains("open") && !secondColItem.classList.contains("open")) {
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (modalEl) {
    ...
    const successContainer = document.querySelector('[data-graph-target="success"]');
    if (successContainer) {
  ...
  document.addEventListener("click", e => {
    ...
    if (target instanceof Element && target.classList.contains("graph-modal") && target.classList.contains("is-open")) {
...
new swiper__WEBPACK_IMPORTED_MODULE_0__.Swiper(".possible__slider_main > .swiper", {
  slidesPerView: 1,
  spaceBetween: 40,
  speed: 500,
  loop: true,
...
new swiper__WEBPACK_IMPORTED_MODULE_0__.Swiper(".possible__slider_sec  > .swiper", {
  slidesPerView: 1,
  spaceBetween: 40,
  speed: 500,
  loop: true,
...
/* harmony import */ var _modal_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modal.js */ "./src/js/components/modal.js");
...
if (document.querySelector(".cta__form")) (0,_functions_validate_forms_js__WEBPACK_IMPORTED_MODULE_0__.validateForms)(".cta__form", rules1, [], afterForm);
if (document.querySelector(".modal__form")) (0,_functions_validate_forms_js__WEBPACK_IMPORTED_MODULE_0__.validateForms)(".modal__form", rules2, [], afterForm);

/***/ }),

/***/ "./src/js/components/wave.js":
/*!***********************************!*\
  !*** ./src/js/components/wave.js ***!
  \***********************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
(() => {
  ...
  const computeShiftFromClientX = (el, clientX) => {
    ...
    const documentWidth = Math.max(1, window.innerWidth || document.documentElement.clientWidth);
...
const validateForms = (selector, rules, checkboxes = [], afterSend) => {
  ...
  validation.onSuccess(ev => {
    ...
    const channel_medium = ev.target.getAttribute("data-channel") || "Форма на сайте";
    const macroParams = {
      name,
      phone,
      ...(email ? {
    ...
    try {
      if (window.macrocrm && typeof window.macrocrm.send_request === "function") {
        window.macrocrm.send_request(macroParams, function (response) {
        ...
        const path = location.origin + "/wp-content/themes/beregovoy/assets/mail.php";
